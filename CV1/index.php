...
<head>
  ...
  <title>CV Alexandre Kebaili</title>
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="#interets">Interets</a>
        </li>
        <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="#certificats">Certificats</a>
        </li>
      </ul>
    </div>
  </nav>
  ...
  <div class="container-fluid p-0">
    ...
    <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="about">
      <div class="w-100">
        <h1 class="mb-0">Alexandre
          <span class="text-primary">KEBAILI</span>
        </h1>
        <div class="subheading mb-5">3 place du colombier, Lieusaint
        ...
        <div class="social-icons">
          ...
          <a href="https://github.com/AlexandreKebaili" target="_blank">
    ...
    <section class="resume-section p-3 p-lg-5 d-flex justify-content-center" id="experiences">
      <div class="w-100">
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
          <div class="resume-content">
            <h3 class="mb-0">Expériences à l’étranger</h3>
    ...
    <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="formation">
      <div class="w-100">
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
          <div class="resume-content">
            <h3 class="mb-0">UPEC Creteil Paris-Est</h3>
            <div class="subheading mb-3">Licence Cloud et Internet des Objets</div>
          </div>
          <div class="resume-date text-md-right">
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
          <div class="resume-content">
            <h3 class="mb-0">GRETA METEHOR ENC Paris</h3>
            <div class="subheading mb-3">BTS SIO option SLAM</div>
          </div>
          <div class="resume-date text-md-right">
            <span class="text-primary">2019 - 2020</span>
          </div>
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
          <div class="resume-content">
            <h3 class="mb-0">Polytheig (alternance)</h3>
            <div class="subheading mb-3">BTS MUC (niveau)</div>
          </div>
          <div class="resume-date text-md-right">
            <span class="text-primary">2010 - 2012</span>
          </div>
        </div>
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
          <div class="resume-content">
            <h3 class="mb-0">Lycée la tour des Dames</h3>
            <div class="subheading mb-3">BAC STG option CFE</div>
          </div>
          <div class="resume-date text-md-right">
    ...
    <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="interets">
      <div class="w-100">
    ...
    <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="certificats">


      <div class="w-100">
        <h2 class="mb-5">Certificats</h2>
        ...
        <div class="resume-content">
         ...
         <ul class="fa-ul mb-0">
          ...
          <li>
            <i class="fa-li fa text-warning"></i>
            Concevez votre site avec PHP et MySQL</li>
          <li>
            <i class="fa-li fa text-warning"></i>
            Adoptez une architecture MVC en PHP</li>
          <li>
            <i class="fa-li fa text-warning"></i>
            Découvrez le framework PHP Laravel</li>
          <li>
            <i class="fa-li fa text-warning"></i>
            Prenez en main Bootstrap</li>
          <li>
            <i class=""></i>
            Apprenez le fonctionnement des réseaux TCP/IP (en cours).</li>
         </ul>
      </div>
    </section>
